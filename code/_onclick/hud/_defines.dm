...
#define ui_ai_camera_up "SOUTH:6,WEST+4"
#define ui_ai_camera_down "SOUTH:6,WEST+4" //Same location as camera_up because these are both half-panels
#define ui_ai_crew_monitor "SOUTH:6,WEST+5"
...
#define ui_ai_tablet "SOUTH:6,WEST+12"
#define ui_ai_radio "SOUTH:6,WEST+13"
