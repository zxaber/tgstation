...
/* Fire alarm and firelock signals. These are all sent to the area the device is located in. */
///Called when a firelock is triggered by atmos conditions
#define COMSIG_FIRELOCK_TRIGGERED "firelock_triggered"
///Called when a fire alarm is triggered by a user
